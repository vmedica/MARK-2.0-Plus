...
class TestMetricsBlackBox:
    ...
    # ------------------------------------------------------------------------
    def test_tc3_multiple_projects_no_python(self, project_root, io_structure, test_repo_dir):
        """TC3: Multiple projects without Python files -> MI = 0 and CC = 0.
    ...
    # TC4: Multiple projects with empty Python files -> MI = 0 and CC = 0
    # ------------------------------------------------------------------------
    def test_tc4_multiple_projects_empty_python(self, project_root, io_structure, test_repo_dir):
        """TC4: Multiple projects with empty Python files -> MI = 0 and CC = 0.
    ...
    # ------------------------------------------------------------------------
    def test_tc5_multiple_projects_valid_python(self, project_root, io_structure, test_repo_dir):
        """TC5: Multiple projects with Python files with valid code -> exact MI and CC values.
